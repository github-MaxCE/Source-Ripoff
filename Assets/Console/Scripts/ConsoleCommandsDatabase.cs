...
public static class ConsoleCommandsDatabase 
{
    ...
    public static void RegisterCommand(string command, ConsoleCommandCallback callback, string description = "")
    {
        RegisterCommand(command, description, callback);
    }
    public static void RegisterCommand(string command, string description, ConsoleCommandCallback callback)
    {
        database[command] = new ConsoleCommand(command, description, callback);
    }
    public static void RegisterCommand(string command, string description, ConsoleCommandCallback callback, object value)
    {
        database[command] = new ConsoleCommand(command, description, callback, value);
    }
