...
public class RebindActionUI : MonoBehaviour
{
    ...
    private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
    {
        ...
        m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
            ...
            .WithControlsExcluding("<Accelerometer>/*")
            .WithControlsExcluding("<AmbientTemperatureSensor>/*")
            .WithControlsExcluding("<AttitudeSensor>/*")
            .WithControlsExcluding("<GravitySensor>/*")
            .WithControlsExcluding("<Gyroscope>/*")
            .WithControlsExcluding("<HumiditySensor>/*")
            .WithControlsExcluding("<LightSensor>/*")
            .WithControlsExcluding("<LinearAccelerationSensor>/*")
            .WithControlsExcluding("<MagneticFieldSensor>/*")
            .WithControlsExcluding("<PressureSensor>/*")
            .WithControlsExcluding("<StepCounter>/*")
            .WithControlsExcluding("<Touchscreen>/*")
            .WithControlsExcluding("<TrackedDevice>/*")
            .WithControlsExcluding("<OculusTrackingReference>/*")
            .WithControlsExcluding("<ViveLighthouse>/*")
            .WithControlsExcluding("<ViveTracker>/*")
            .WithControlsExcluding("<XRController>/*")
            .WithControlsExcluding("<XRHMD>/*")
            .WithControlsExcluding("<HID>/*")
            .WithControlsExcluding("<OculusRemote>/*")
