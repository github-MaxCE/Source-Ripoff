...
namespace MaxCE.Binding.Editor
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_ConsoleProperty = serializedObject.FindProperty("m_Console");
            m_playerInputProperty = serializedObject.FindProperty("m_playerInput");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_ConsoleProperty);
                EditorGUILayout.PropertyField(m_playerInputProperty);
        ...
        private SerializedProperty m_ConsoleProperty;
        private SerializedProperty m_playerInputProperty;
